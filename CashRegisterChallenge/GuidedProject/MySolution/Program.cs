...
var valueGenerator = new Random(1);
...
static void MakeChange(int cost, int[] cashTill, int twenties, int tens = 0, int fives = 0, int ones = 0)
{
    ...
    while ((changeNeeded > 19) && (cashAvailable[3] > 0))
    {
        cashAvailable[3]--;
        changeNeeded -= 20;
    ...
    while ((changeNeeded > 9) && (cashAvailable[2] > 0))
    {
        cashAvailable[2]--;
        changeNeeded -= 10;
    ...
    while ((changeNeeded > 4) && (cashAvailable[1] > 0))
    {
        cashAvailable[1]--;
        changeNeeded -= 5;
    ...
    while ((changeNeeded > 0) && (cashAvailable[0] > 0))
    {
        cashAvailable[0]--;
        changeNeeded--;
    ...
    cashTill[3] = cashAvailable[3];
    cashTill[2] = cashAvailable[2];
    cashTill[1] = cashAvailable[1];
    cashTill[0] = cashAvailable[0];
}
